...
export type GetSpaceXSeoQuery = { __typename?: 'Query', company?: { __typename?: 'Info', ceo?: string | null } | null };
 ...
 * });
 */
export function useGetSpaceXSeoQuery(baseOptions?: Apollo.QueryHookOptions<GetSpaceXSeoQuery, GetSpaceXSeoQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetSpaceXSeoQuery, GetSpaceXSeoQueryVariables>(GetSpaceXSeoDocument, options);
      }
export function useGetSpaceXSeoLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetSpaceXSeoQuery, GetSpaceXSeoQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetSpaceXSeoQuery, GetSpaceXSeoQueryVariables>(GetSpaceXSeoDocument, options);
        }
export type GetSpaceXSeoQueryHookResult = ReturnType<typeof useGetSpaceXSeoQuery>;
export type GetSpaceXSeoLazyQueryHookResult = ReturnType<typeof useGetSpaceXSeoLazyQuery>;
export type GetSpaceXSeoQueryResult = Apollo.QueryResult<GetSpaceXSeoQuery, GetSpaceXSeoQueryVariables>;
